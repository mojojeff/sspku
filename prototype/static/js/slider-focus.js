pHPSetupFunction=function(){
	...
	var E=jQuery("#p-top-main #p-banner-1 h1 a").html();
	var H=jQuery("#p-banner-1 p em:first").clone();
	
	jQuery("span",H).remove();
	jQuery("#p-top-main #p-banner-1 h1").append("<p>"+H.text()+"</p>");
	jQuery(".p-top-qh-nav a:nth-child(1) .p-top-qh-view").addClass("p-banner-small-1").children("div.p-banner-small-alt").prepend('<span class="p-banner-small-1"></span><h4>'+E+"</h4><p>"+H.text()+"</p>");
	
	var C=jQuery("#p-top-main #p-banner-2 h2 a").html();
	var G=jQuery("#p-banner-2 p em:first").clone();
	
	jQuery("span",G).remove();
	jQuery("#p-top-main #p-banner-2 h2").append("<p>"+G.text()+"</p>");
	jQuery(".p-top-qh-nav a:nth-child(2) .p-top-qh-view").addClass("p-banner-small-2").children("div.p-banner-small-alt").prepend('<span class="p-banner-small-2"></span><h4>'+C+"</h4><p>"+G.text()+"</p>");
	
	var B=jQuery("#p-top-main #p-banner-3 h2 a").html()
	var D=jQuery("#p-banner-3 p em:first").clone();

	jQuery("span",D).remove();
	jQuery("#p-top-main #p-banner-3 h2").append("<p>"+D.text()+"</p>");
	jQuery(".p-top-qh-nav a:nth-child(3) .p-top-qh-view").addClass("p-banner-small-3").children("div.p-banner-small-alt").prepend('<span class="p-banner-small-3"></span><h4>'+B+"</h4><p>"+D.text()+"</p>");
